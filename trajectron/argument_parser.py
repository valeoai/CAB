...
# HEDI: custom parameters

parser.add_argument('--statedropout_keep_prob',
                    help="Probability to keep the state during training",
                    type=float,
                    default=-10)
parser.add_argument('--perturb_proba',
                    help="Probability to perturb (ackerman perturbation - chauffeurnet) an example during training",
                    type=float,
                    default=-10)
